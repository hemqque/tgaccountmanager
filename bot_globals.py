...
# Общий доступ к аккаунтам (шаринг)
_share_pending: Dict[int, List[str]] = {}      # uid -> список телефонов для шаринга
_shr_selection: Dict[int, set] = {}            # uid -> выбранные телефоны (ручной выбор)
_shr_grp_selection: Dict[int, set] = {}        # uid -> выбранные группы (мультивыбор)
_SHR_SEL_PER_PAGE: int = 6
